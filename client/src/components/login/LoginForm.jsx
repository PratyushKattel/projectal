...
const LoginForm = () => {
  return (
    <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-8 md:px-16 py-8 md:py-16">
      <div className="w-full max-w-md">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#2557D6] hover:bg-[#1e46af] text-white font-bold py-4 rounded-xl transition shadow-lg"
          >
            Sign in
          </button>
        </form>
        ...
        <button
          type="button"
          className="w-full border border-gray-200 py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition font-semibold text-gray-700"
        >
          <img
